...
test.skip("A string of just one number", () => {
  const input = "11111111111";

  expect(longestRunOfTwoNumbers(input)).toBe("11111111111");
});

test.skip("A string that contains a non number character", () => {
...
test.skip("A string which longest run is of a non numerical character", () => {
